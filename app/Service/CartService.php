...
class CartService
{
    ...
    public function addItemToCart(Product $product, int $quantity = 1, $optionIds = null)
    {
        ...
        $price = $product->getPriceForOption($optionIds);
    ...
    public function updateItemQuantity(int $productId, int $quantity, $optionIds = null)
    {
        if (Auth::check()) {
            ...
            $this->updateCartItemQuantityInCookies($productId, $quantity, $optionIds);
        }
    }

    public function removeItemForCart(int $productId, $optionIds = null)
    {
        if (Auth::check()) {
            $this->removeCartItemFromDatabase($productId, $optionIds);
        } else {
            $this->removeCartItemFromCookies($productId, $optionIds);
        }
    }
    ...
    protected function updateCartItemQuantityInCookies(int $productId, int $quantity, array $optionIds)
    {
        $cartItems = $this->getCartItemsFromCookies();
    ...
    protected function removeCartItemFromDatabase(int $productId, array $optionIds)
    {
        $userId = Auth::id();
    ...
    protected function removeCartItemFromCookies(int $productId, array $optionIds)
    {
        $cartItems = $this->getCartItemsFromCookies();
